...
app.addDownloadLink = function (id, type, title, newTitle) {
  ...
  elA.setAttribute("name", fileName);
  elA.setAttribute("id", "directdownloadid");
  elA.setAttribute("style", 'cursor:pointer');
  elA2.setAttribute("name", directURL.toString());
  elA2.setAttribute("id", "directdownloadidforurl");
